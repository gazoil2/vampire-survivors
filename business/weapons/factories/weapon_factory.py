...
class WeaponFactory:
    ...
    def get_red_wand() -> IWeapon:
        return Weapon( ProjectileStats(damage=10, velocity=5, area_of_effect=1.5, reload_time=800, pierce=4, duration=1000),RedBulletFactory(), "Red Wand")

    @staticmethod
    def get_big_bow() -> IWeapon:
        return Weapon(ProjectileStats(damage=20, velocity=3, area_of_effect=2, reload_time=8000, pierce=20, duration=500 ), BigBulletFactory(), "Big Bow") 
    ...
    def get_spectral_wand() -> IWeapon:
        return Weapon(ProjectileStats(damage=2, velocity=0, area_of_effect=3, reload_time=700, pierce=80, duration=300), TrailBulletFactory(), "Spectral Wand")
