...
class GreenWand(IWeapon):
    def __init__(self, projectile_stats: ProjectileStats, atack_shape: IAtackShapeFactory, json_file: str, weapon_level: int = 1):
        ...
        self.__upgrade = Upgrade("GreenWand", json_file) 
